...
def data_lib_bldr(contour_structure_lookup_table = ['RTst']):
    """
    This function is meant to scan the file system and 
    return a set of nested lists containing the paths 
    to the data
    """
    ...
    return global_patient_list # return the global_patient_list

def main():
    print('This is the data builder programme, it is not meant to be run directly.')
