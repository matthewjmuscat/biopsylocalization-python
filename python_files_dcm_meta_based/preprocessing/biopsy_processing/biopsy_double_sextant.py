...
def _build_per_sample_point_double_sextant_dataframe(master_structure_reference_dict,
    ...
    return all_biopsies_per_sample_point_double_sextant_prostate_location_df
...
def biopsy_double_sextant_processer(master_structure_reference_dict,
    ...
    all_biopsies_per_sample_point_double_sextant_prostate_location_df = _build_per_sample_point_double_sextant_dataframe(
