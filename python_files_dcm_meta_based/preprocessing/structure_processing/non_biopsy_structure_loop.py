...
def process_patient_non_biopsy_structure_family(
        *,
        patient_uid,
        pydicom_item,
        master_structure_reference_dict,
...
def process_patient_standard_non_biopsy_structure_families(
        *,
        patient_uid,
        pydicom_item,
        oar_ref,
    ...
    for family_config in family_configs:
        live_display = process_patient_non_biopsy_structure_family(
            patient_uid=patient_uid,
            pydicom_item=pydicom_item,
            master_structure_reference_dict=master_structure_reference_dict,
            master_structure_info_dict=master_structure_info_dict,
