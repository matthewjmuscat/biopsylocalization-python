...
from validation.cohort_csv_comparator import (
    compare_cohort_output_dirs,
    default_comparison_output_dir,
    format_console_summary,
    write_comparison_outputs,
)
from validation.run_output_paths import resolve_existing_output_dir


def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Compare two main-algorithm output directories at the cohort CSV level and "
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "validation_outputs/run_comparisons/<baseline>__vs__<candidate>."
        ),
    )
    parser.add_argument(
        "--abs-tol",
...
def main() -> None:
    ...
    output_dir = args.output_dir or default_comparison_output_dir(baseline_dir, candidate_dir)
