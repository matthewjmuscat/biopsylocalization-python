...
| --- | --- | --- |
| `latest_standard_candidate_core` | Yes | Fast current checks for the Jun 06 13:51 latest standard run: one recursive health check and one cohort oracle check against Jun 05 21:17. |
...
Known interpretation from the latest Jun 06 13:51 validation set:

- Cohort outputs matched Jun 05 21:17, Jun 05 15:05, Jun 04 22:23, Jun 04 00:32, Jun 03 14:36, and Jun 02 01:47 with 22/22 tables and zero drift.
...
- The `current_dosimetry_shadow` runner manifests from the Jun 06 13:51 run showed both scientific shadow and live patient-scientific runner execution succeeded for all 4 patients through MC prep and MC simulation. Artifact writing remained disabled for this scientific-stage checkpoint, so patient-runner cohort assembly/parity still requires a separate artifact-writing and assembly pass.
