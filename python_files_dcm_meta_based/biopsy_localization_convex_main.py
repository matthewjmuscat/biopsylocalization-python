...
def main():
    ...
    patient_runner_validation_scientific_shadow_pathway_name = "biopsy_preprocessing_shadow"
    ...
    patient_scientific_runner_checkpoint_name = "biopsy_preprocessing_shadow"
    patient_scientific_runner_pathway_name = "biopsy_preprocessing_shadow" # Second live-runner slice: grid preprocessing -> anatomical preprocessing -> biopsy preprocessing.
