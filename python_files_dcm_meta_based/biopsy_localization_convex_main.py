...
def main():
    ...
    patient_runner_validation_scientific_shadow_pathway_name = "current_dosimetry_shadow"
    ...
    patient_scientific_runner_pathway_name = "current_dosimetry_shadow" # Sixth live-runner slice: through MC prep and MC simulation after sampling/classification.
