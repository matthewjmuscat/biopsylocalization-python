...
OUTPUT_TABLE_SPECS = (
    ...
    _spec("cohort_dil_global_tissue_scores_features", "Cohort: DIL global tissue scores and DIL features", "Output CSVs/Cohort", "cohort", "tissue_class", "biopsy_relative_structure", _key("Patient ID", "Bx index", "Relative structure type", "Relative structure index"), stitch_method="join_derived", validation_status="needs_aggregation_builder", downstream_usage="not_found_in_sibling_scan"),
...
def build_output_schema_coverage_report(phase3c_manifest_df: pd.DataFrame,
    ...
    for spec in registry.specs:
        ...
        elif spec.validation_status in {"metadata_only", "needs_aggregation_builder", "needs_recompute_validation"}:
